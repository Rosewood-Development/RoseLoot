...
public class VanillaLootTableConverter {
    ...
    private static final String[] HEADER = new String[] {
            ...
            "# As this is an example, it will not be used by default. To do so move it to the 'plugins/RoseLoot/loottables' folder.",
            "# Please do not copy every example file into the loottables folder, only the ones you modify."
    };
