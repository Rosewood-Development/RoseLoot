...
import dev.rosewood.roseloot.loot.item.component.common.stable.AttackRangeComponent;
...
import dev.rosewood.roseloot.loot.item.component.common.stable.MinimumAttackChargeComponent;
...
import dev.rosewood.roseloot.loot.item.component.common.stable.PiercingWeaponComponent;
...
import dev.rosewood.roseloot.loot.item.component.common.stable.UseEffectsComponent;
...
public class LootItemComponentProviderImpl implements LootItemComponentProvider {
    ...
    public Map<String, Function<ConfigurationSection, LootItemComponent>> provideLootItemComponentConstructors() {
        return Map.<String, Function<ConfigurationSection, LootItemComponent>>ofEntries(
                Map.entry("attack-range", AttackRangeComponent::new),
                ...
                Map.entry("damage-type", DamageTypeComponent::new),
                ...
                Map.entry("kinetic-weapon", KineticWeaponComponent::new),
                ...
                Map.entry("minimum-attack-charge", MinimumAttackChargeComponent::new),
                ...
                Map.entry("piercing-weapon", PiercingWeaponComponent::new),
                ...
                Map.entry("swing-animation", SwingAnimationComponent::new),
                ...
                Map.entry("use-effects", UseEffectsComponent::new),
    ...
    public Map<String, BiConsumer<ItemStack, StringBuilder>> provideLootItemComponentPropertyApplicators() {
        return Map.<String, BiConsumer<ItemStack, StringBuilder>>ofEntries(
                Map.entry("attack-range", AttackRangeComponent::applyProperties),
                ...
                Map.entry("damage-type", DamageTypeComponent::applyProperties),
                ...
                Map.entry("kinetic-weapon", KineticWeaponComponent::applyProperties),
                ...
                Map.entry("minimum-attack-charge", MinimumAttackChargeComponent::applyProperties),
                ...
                Map.entry("piercing-weapon", PiercingWeaponComponent::applyProperties),
                ...
                Map.entry("swing-animation", SwingAnimationComponent::applyProperties),
                ...
                Map.entry("use-effects", UseEffectsComponent::applyProperties),
