...
public class ConsumableComponent implements LootItemComponent {
    ...
    public void apply(ItemStack itemStack, LootContext context) {
        ...
        if (this.consumeSeconds != null)
            builder.consumeSeconds(this.consumeSeconds.getFloat(context));
        ...
        if (this.effects != null)
            builder.addEffects(this.effects.stream().map(x -> x.toConsumeEffect(context)).toList());
