...
public class EquippableComponent implements LootItemComponent {
    ...
    private final StringProvider shearingSound;
    ...
    public EquippableComponent(ConfigurationSection section) {
        ...
        if (equippableSection != null) {
            ...
            this.shearingSound = StringProvider.fromSection(equippableSection, "shearing-sound", null);
            ...
            this.canBeSheared = equippableSection.getBoolean("can-be-sheared", false);
        } else {
    ...
    public void apply(ItemStack itemStack, LootContext context) {
        ...
        if (this.shearingSound != null) {
            Key key = Key.key(this.shearingSound.get(context).toLowerCase());
            builder.shearSound(key);
        }
    ...
    public static void applyProperties(ItemStack itemStack, StringBuilder stringBuilder) {
        ...
        stringBuilder.append("  shearing-sound: '").append(equippable.shearSound().asMinimalString()).append("'\n");
        ...
        stringBuilder.append("  can-be-sheared: ").append(equippable.canBeSheared()).append('\n');
    }
